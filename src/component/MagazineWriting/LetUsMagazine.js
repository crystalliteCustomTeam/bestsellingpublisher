        ...
        <>
            <section className="py-[100px] relative font-secondary ">
                <div className="container max-w-7xl lg:max-w-6xl relative z-10 font-secondary text-center sm:px-5">
                    ...
                    <h3 className=' mx-auto font-semibold leading-[70px] text-[40px] sm:text-4xl xs:text-3xl sm:py-5 xs:py-5 sm:w-[100%] xs:w-[90%]'>
                    ...
                    <div className={`grid w-[80%] ${isLargeScreen ? '' : 'hidden'} md:w-[95%] mx-auto md:grid-cols-2 grid-cols-3 gap-5 mt-12 items-stretch justify-stretch md:px-5`}>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Essay <br></br>Articles</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Historical <br></br> Articles</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Profile <br></br> Articles</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Service <br></br>Articles</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Research <br></br> Articles</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <h4 className='text-xl font-semibold mx-auto '>Informative <br></br> Articles</h4>
                            </div>
                        </div>
                    </div>
