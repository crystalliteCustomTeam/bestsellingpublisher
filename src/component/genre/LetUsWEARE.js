            ...
            <section className="pt-[100px] md:py-20 sm:py-10 xs:py-10 font-secondary">
                <div className="container max-w-7xl lg:max-w-6xl">
                    <div className="text-center justify-content-center ">
                        ...
                        <h2 className='text-[40px] font-semibold font-primary mb-2 lg:text-5xl py-3 md:text-4xl sm:text-3xl xs:text-4xl sm:py-5'>The Greatness of Our Team Cannot Be Understated</h2>
                        <p className='w-[80%] mx-auto lg:w-[95%] md:w-[90%] sm:w-[90%] sm:text-justify xs:w-[90%] xs:text-justify'>
